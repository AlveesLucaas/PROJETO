...
variable "os_disk_size" {
  description = "Tamanho do disco de Sistema Operacional"
  type        = string
}
...
variable "rg_backup_vault" {
  description = "Grupo de recursos do Backup Vault"
  type        = string
  default     = "grprd-bmgseg"
}

variable "vault_backup_name" {
  description = "Nome do Backup Vault"
  type        = string
  default     = "RSV-GRPRD-BMGSEG-01"
}

variable "backup_policy_id" {
  description = "ID da política de backup"
  type        = string
  default     = "/subscriptions/56dfde38-0ae3-49a8-9fec-37a8c1bb2087/resourceGroups/GRPRD-BMGSEG/providers/Microsoft.RecoveryServices/vaults/RSV-GRPRD-BMGSEG-01/backupPolicies/LINUX-BACKUP"
}
